...
const data: CardItem[] = [
  ...
  { id: '3', title: 'Feijão 1kg', image: require('@/app/imgP/geral/arroz.jpg'), valor: 6.0, },
  { id: '4', title: 'Leite 1L', image: require('@/app/imgP/geral/arroz.jpg'), valor: 2.99, },
  { id: '5', title: 'Arroz 5kg', image: require('@/app/imgP/geral/arroz.jpg'), valor: 5.0, },
  { id: '6', title: 'Feijão 1kg', image: require('@/app/imgP/geral/arroz.jpg'), valor: 6.0, },
  { id: '7', title: 'Leite 1L', image: require('@/app/imgP/geral/arroz.jpg'), valor: 2.99, },
  { id: '8', title: 'Arroz 5kg', image: require('@/app/imgP/geral/arroz.jpg'), valor: 5.0, },
  { id: '9', title: 'Feijão 1kg', image: require('@/app/imgP/geral/arroz.jpg'), valor: 6.0, },
  { id: '10', title: 'Leite 1L', image: require('@/app/imgP/geral/arroz.jpg'), valor: 2.99, },
  { id: '11', title: 'Arroz 5kg', image: require('@/app/imgP/geral/arroz.jpg'), valor: 5.0, },
  { id: '12', title: 'Feijão 1kg', image: require('@/app/imgP/geral/arroz.jpg'), valor: 6.0, },
];
...
export default function CardsBebidas({darkMode} : CardSliderProps) {
